                ...
                <ul className="grid gap-6">
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        I believe in clean, efficient code and user-centered design. Every project I work on is built
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        My goal is to create web experiences that are not only visually appealing but also functional
